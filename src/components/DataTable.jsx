...
const App = () => {
  ...
  const [filter, setFilter] = useState({ minGames: 0, maxGames: 1000, minELO: 0, maxELO: 5000 });
    ...
    <div className="container">
      ...
      <div className="filters">
        ...
        <input 
          type="number" 
          placeholder="Мин. игр" 
          onChange={(e) => setFilter({ ...filter, minGames: Number(e.target.value) })} 
        />
        <input 
          type="number" 
          placeholder="Макс. игр" 
          onChange={(e) => setFilter({ ...filter, maxGames: Number(e.target.value) })} 
        />
        <input 
          type="number" 
          placeholder="Мин. ELO" 
          onChange={(e) => setFilter({ ...filter, minELO: Number(e.target.value) })} 
        />
        <input 
          type="number" 
          placeholder="Макс. ELO" 
          onChange={(e) => setFilter({ ...filter, maxELO: Number(e.target.value) })} 
        />
      </div>
