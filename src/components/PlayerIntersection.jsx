...
import gamesData from '../../rawData/all_rating_transform.json'
...
const PlayerIntersection = ({ playerName }) => {
  ...
  const [sortConfig, setSortConfig] = useState({ column: 'Общее', direction: 'asc' })
        ...
        <table border="1">
          <thead>
            <tr>
              ...
              <th onClick={() => handleSort('РазноцветМирный')}>Разноцвет игрок мирный</th>
              <th onClick={() => handleSort('РазноцветЧерный')}>Разноцвет игрок черный</th>
            </tr>
          </thead>
          <tbody>
