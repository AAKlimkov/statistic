					...
					>
						...
						{!player.isPlaceholder && (
							<ButtonGroup size='small' variant='outlined'>
								<Tooltip title='Победитель (в верхнюю сетку)'>
									<IconButton
										onClick={() =>
											onPlayerSelect(match.id, player.id, 'winner')
										}
										color={
								...
								<Tooltip title='Проигравший (в нижнюю сетку)'>
									<IconButton
										onClick={() =>
								...
								<Tooltip title='Выбыл из турнира'>
									<IconButton
										onClick={() => onPlayerSelect(match.id, player.id, 'loser')}
										color={
											matchSelections[player.id] === 'loser'
												? 'error'
												: 'default'
										}
									>
